...
<main>
    <section class="container py-4 ">
        ...
        <a href="{{route('admin.characters.create')}}" class="btn btn-primary my-3">Create new Character</a>
            ...
            <div class="col-12 col-md-4 col-lg-3">
                <div class="card w-100 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('admin.characters.show', $character->id)}}" class="btn btn-primary">See details</a>
